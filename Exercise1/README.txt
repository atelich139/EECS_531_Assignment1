    This is the first exercise in assignment 1. The object of this exercise was to
implement an image blur filter "by hand".

    I chose to implement a Gaussian image blur filter. The following python code contains
